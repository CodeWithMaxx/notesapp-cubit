...
class _NotesViewState extends State<NotesView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("𝐌𝐲 𝐍𝐨𝐭𝐞",style: TextStyle(fontSize: 22),),
        centerTitle: true,
        ...
        backgroundColor: Colors.white,
          ...
          items:[
            ...
            IconButton(onPressed: (){
              ...
              BlocProvider.of<NotesCubit>(context).updatenotes(widget.id!,titleController.text.toString(), descController.text.toString(),);
            ...
            IconButton(onPressed: (){
              showAdaptiveDialog(context: context, builder: (context){
                return AlertDialog(
                  title: Text("Warning",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  content: Text("Are you sure to delete this ${titleController.text} please confirm" ),
                  actions: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10,),
                        TextButton(onPressed: (){
                          BlocProvider.of<NotesCubit>(context).deletenotes(widget.id!);
                          Navigator.of(context).pop();
            ...
            }, icon: const Icon(Icons.delete_forever_outlined,size: 27,color: Colors.white,))
          ]
      ),
    );
  }
